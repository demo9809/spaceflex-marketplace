...
export function ListingWizard() {
  ...
  return (
    <div className="container-site max-w-3xl pb-40 pt-8 md:py-14">
      ...
      <div className="fixed inset-x-0 bottom-16 z-40 border-t border-line bg-paper/95 px-4 py-3 backdrop-blur-xl md:static md:z-auto md:mt-6 md:border-0 md:bg-transparent md:px-8 md:py-0 md:backdrop-blur-none">
