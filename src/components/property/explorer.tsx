      ...
      {drawer.mounted && (
          <>
            ...
            <aside
              ...
              className={cn(
                "fixed bottom-0 right-0 z-50 flex max-h-[88svh] w-full flex-col rounded-t-3xl bg-raised shadow-modal transition-transform duration-400 [transition-timing-function:cubic-bezier(0.16,1,0.3,1)] md:top-0 md:h-full md:max-h-none md:w-[26rem] md:rounded-none",
                drawer.shown
