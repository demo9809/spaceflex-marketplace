...
export function MobileTabBar() {
  ...
  return (
    <nav
      ...
      className={cn(
        "fixed inset-x-0 bottom-0 z-50 border-t border-line bg-paper/90 pb-[env(safe-area-inset-bottom,0px)] backdrop-blur-xl md:hidden transition-all duration-300 ease-out will-change-transform",
        !navVisible &&
